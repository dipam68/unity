...
function Edit(props) {
    ...
    const frmEditUser = (e) => {
        e.preventDefault();
        axios
        .put('http://127.0.0.1:8000/api/user/update', {id:data.id, name:name}, {
          headers: {
  ...
  return (
    ...
    <div className="col-md-8 mt-10 data-content">
      <h2 className='border border-info'>Edit User</h2>
        <div className='row'>
        ...
        <div className='row'>
          ...
          <form onSubmit={frmEditUser} className='form-inline'>
